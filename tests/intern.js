...
define({
    ...
    environments: [
        ...
        { browserName: 'firefox', version: '44', platform: [ 'WINDOWS', 'MAC' ] },
        { browserName: 'chrome', version: '48', platform: [ 'WINDOWS', 'MAC' ] },
        //{ browserName: 'safari', version: '9', platform: 'MAC', browser_version: "9.0", os: "OS X", os_version: "El Capitan", browser: "safari" }
    ],
    ...
    loaderOptions: {
        ...
        packages: [ {name: 'jquery.shell.js', location: './dist/js/jquery.shell.min.js'} /*{ name: 'myPackage', location: '.' } */ ]
    },
